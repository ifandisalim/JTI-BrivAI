...
**Full local setup (web + Android + Supabase + tests):** see `[docs/dev/local-setup-and-testing-playbook.md](docs/dev/local-setup-and-testing-playbook.md)` (JTI-159).

**Local-first + one-command startup (Windows/PowerShell):** see `[docs/dev/local-first-runbook.md](docs/dev/local-first-runbook.md)`.

This README stays the short entry; the dev playbooks expand commands and checklists.
