---
name: help
description: Shows the user everything Claude can help with in this workspace. Trigger this skill whenever the user says "help", "what can you do?", "what can I say?", "how does this work?", "what are my options?", "I'm lost", "what now?", or seems confused about what to do next. This is especially useful right after setup when a new user doesn't know what's possible.
---
